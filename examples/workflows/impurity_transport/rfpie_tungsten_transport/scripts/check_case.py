...
PROCESS_DATABASE = CASE_DIR.parents[3] / "database/processes.h5"
...
def main() -> None:
    cfg = json.loads((CASE_DIR / "input/config.json").read_text())
    ...
    notebook = nbformat.read(CASE_DIR / "scripts/analysis.ipynb", as_version=4)
