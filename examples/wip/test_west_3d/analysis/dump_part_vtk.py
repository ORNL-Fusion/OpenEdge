...
def build_parser():
    ...
    parser.add_argument(
        "--trajectories",
        action="store_true",
        help="Alias for --mode trajectories",
    )
...
if __name__ == "__main__":
    ...
    if args.trajectories:
        if args.mode not in ("series", "trajectories"):
            parser.error("--trajectories cannot be combined with --mode points")
        args.mode = "trajectories"
