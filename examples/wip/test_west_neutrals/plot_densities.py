#!/usr/bin/env python3
"""Plot D2, D, D+ density maps from test_west_neutrals output at the final timestep.
...
OUT  = 'output/west_neutrals_densities.png'
...
fig.suptitle(f'test_west_neutrals: D2/D/D+ neutral transport with wall recycling\n'
             f'real WEST axi (SOLEDGE3X 3 MW plasma) geometry, Boris pusher, 4-reaction chem/adas '
