...
- heatflux.h5 uses 2D grid + fields:
    ...
    python3 /Users/42d/OpenEdge/examples/test_d3d_walldyn/input/solps2openedge_noheat.py \
    "/Users/42d/ORNL Dropbox/Abdou Diaw/SOLPS_DB/ens__DIII-D__APP-FPP__D_C_Ne__ss__lhs__20250124_144649/run_a41e66db__D_C_Ne" \
    --equ-file /Users/42d/OpenEdge/examples/test_d3d_walldyn/input/g174310.03500_153.X4.equ \
    --plasma-out /Users/42d/OpenEdge/examples/test_d3d_walldyn/input/plasma.h5 \
    --bfield-out /Users/42d/OpenEdge/examples/test_d3d_walldyn/input/bfield.h5 \
    --wall-out /Users/42d/OpenEdge/examples/test_d3d_walldyn/input/wall.txt \
    --case-name d3d \
    --plot
...
def convert_solps_to_openedge(
    ...
    # Write heatflux.h5 only if requested and available.
    if heatflux_out is not None and qmag_grid is not None:
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--heatflux-out", type=Path, default=None, help="Optional heatflux.h5 output; omit to skip heatflux generation")
