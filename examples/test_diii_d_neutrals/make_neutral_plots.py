...
`fix volume/chem/adas` summary-mode dump.

Reads the multi-snapshot text dump produced by `in.diii_d_neutrals`
(16 cols: id xc yc xlo ylo xhi yhi  n_D2 n_D n_D+  Sp Smx Smy Smz Qe Qi),
...
# Dump schema (matches in.diii_d_neutrals: f_fden[1..3] = n_D2 n_D n_D+
# from compute grid/weighted ... species; D+ column is all zeros in this
# pure-neutral deck but we keep it so the schema mirrors the species file).
COL_ID  = 0
COL_XC  = 1   # SPARTA x = Z
COL_YC  = 2   # SPARTA y = R
COL_XLO = 3
