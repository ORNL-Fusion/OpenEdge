<!-- Adapted from the SPARTA manual (create_box.txt); Plimpton, Gallis et al., Sandia National Laboratories. OpenEdge extensions marked. -->
...
For a 2d simulation, as specifed by the dimension command, *zlo* < 0.0 and *zhi* > 0.0 is required.  This means the z dimensions straddle 0.0.  Typical values are -0.5 and 0.5, but this is not required.  See Section 6.1 of the manual for more information about 2d simulations.
