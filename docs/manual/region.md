<!-- Adapted from the SPARTA manual (region.txt); Plimpton, Gallis et al., Sandia National Laboratories. OpenEdge extensions marked. -->
...
This command defines a geometric region of space.  Various other commands use regions.  See the group grid, "group surf"_group, and dump_modify commands for examples.
