<!-- Adapted from the SPARTA manual (dimension.txt); Plimpton, Gallis et al., Sandia National Laboratories. OpenEdge extensions marked. -->
...
Set the dimensionality of the simulation.  By default OpenEdge runs 3d simulations, but 2d simulations can also be run.
