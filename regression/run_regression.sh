...
declare -a TESTS=(
  ...
  "grain_boron_west|test_grain_boron|in.b_west_drop|../test_west_cases/input/plasma.h5"
  "west_axi_emission|test_west_cases|in.axi_west_emission|input/plasma.h5"
