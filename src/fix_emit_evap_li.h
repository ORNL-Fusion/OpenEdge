...
FixStyle(emit/evap/li,FixEmitEvapLi)

#else

#ifndef SPARTA_FIX_EMIT_EVAP_LI_H
#define SPARTA_FIX_EMIT_EVAP_LI_H
...
class FixEmitEvapLi : public FixEmit {
 public:
  FixEmitEvapLi(class SPARTA *, int, char **);
  ~FixEmitEvapLi();
  void init();
