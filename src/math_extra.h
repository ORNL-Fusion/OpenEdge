...
namespace MathExtra {
  ...
  inline void bilinearInterpolate(double x0, double x1, double y0, double y1, 
...
/* ----------------------------------------------------------------------
   compute nearest point using a bilinear interpolation
------------------------------------------------------------------------- */
void MathExtra::bilinearInterpolate(double x0, double x1, double y0, double y1, 
  double f00, double f01, double f10, double f11,
  double x, double y, double &result) {
// Inline bilinear interpolation logic
double fx0 = ((x1 - x) * f00 + (x - x0) * f10) / (x1 - x0);
double fx1 = ((x1 - x) * f01 + (x - x0) * f11) / (x1 - x0);
result = ((y1 - y) * fx0 + (y - y0) * fx1) / (y1 - y0);
}
