...
// Reflection::Table is defined in reflection_tables.h.
...
class SurfReactPMI : public SurfReact {
 ...
 protected:
  ...
  // Reflection-table storage (name-indexed).  Populated at
  // parse time when a reaction is declared with style TRIM_STYLE.
  std::string trim_dir;
