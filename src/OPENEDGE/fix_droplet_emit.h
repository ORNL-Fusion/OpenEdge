/* ----------------------------------------------------------------------
   OpenEdge: fix particulate/emit — inject particulate grains/droplets from
   a surface or point source with the particulate size and temperature
   attributes (radius, temp) set at creation.
------------------------------------------------------------------------- */
