...
inline double li_evap_flux(double T_C, double sticking = 1.0)
{
...
inline double li_evap_cooling(double flux, double H_vap = 145920.0)
{
...
inline double li_adatom_flux(double T_C, double Gamma_Dp,
