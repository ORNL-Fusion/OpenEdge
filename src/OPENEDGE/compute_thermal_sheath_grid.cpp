...
#include "stdlib.h"
#include "string.h"
#include "compute_thermal_sheath_grid.h"
#include "particle.h"
#include "mixture.h"
#include "grid.h"
#include "update.h"
...
ComputeThermalSheathGrid::ComputeThermalSheathGrid(SPARTA *sparta, int narg, char **arg) :
...
ComputeThermalSheathGrid::~ComputeThermalSheathGrid()
{
  if (copymode) return;
...
void ComputeThermalSheathGrid::init()
{
...
void ComputeThermalSheathGrid::compute_per_grid()
{
...
int ComputeThermalSheathGrid::query_tally_grid(int index, double **&array, int *&cols)
{
  index--;
...
void ComputeThermalSheathGrid::reallocate()
{
...
bigint ComputeThermalSheathGrid::memory_usage()
{
  bigint bytes = 0;
