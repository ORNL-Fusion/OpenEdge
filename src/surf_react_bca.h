...
SurfReactStyle(bca,SurfReactBca)

#else

#ifndef SPARTA_SURF_REACT_BCA_H
#define SPARTA_SURF_REACT_BCA_H
...
class SurfReactBca : public SurfReact {
 public:
  SurfReactBca(class SPARTA *, int, char **);
  SurfReactBca(class SPARTA *sparta) : SurfReact(sparta) {} // needed for Kokkos
  virtual ~SurfReactBca();
  virtual void init();
