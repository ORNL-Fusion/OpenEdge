...
# SOLPS is axisymmetric, so we always write SPARTA's true axisymmetric
# layout: column 1 = Z (axial), column 2 = R (radial). Use with
# `boundary o ao p`, `create_box ... 0 R_max ...`.
